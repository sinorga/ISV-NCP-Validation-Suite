...
def main() -> int:
    ...
    try:
        ...
        # SubnetConfigCheck reads `step_output.subnets` (top-level) for the
        # min_subnets count assertion; surface the list there in addition
        # to tests.create_subnets.subnets so the validator sees it.
